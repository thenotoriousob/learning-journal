...
const heroSectionSel = document.getElementById("hero-section");
const selectedArticleEl = document.querySelector(".selected-article");
const aboutMeEl = document.querySelector(".about-me");
const moduleEl = document.querySelector(".selected-module");
        ...
        <div class="container">
            <section>
                <div class="main-article-header-container">
                    ...
                    <p class="article-summary">I started the bootcamp end of June 2024 and I wanted to track my what I have learned.</p>
                </div>
                ...
                <div class="main-article-content-container">
                    <div class="article-content">
                        ...
                        <p class="article-content-text">The key difference with Scrimba is that you are writing code from day 1 so you are always getting to put into practice what you are learning. That definitely helps when you are doing a long course, it would get very boring just watching videos.</p>
...
const renderBlogs = (displayRecentPostText) => {
    ...
    blogData.forEach((blog, index) => {
        ...
        if (index < noOfArticles) {
            const { title, image, published, summary } = blog;

            html += `
                    <article class="article">
                        <img class="article-img" src="${image}" alt="" data-article-id="${index}">
